%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Main file for Simulation 1 for Universal Solution to the TIE.
% Version 2.0 -
% Related Reference:
...
sigma = 1.0e-4;    % sigma of Gaussian intensity distribution (m)
...
if abs(mean2(dIdz))>1e-7    % Need to check the threshold (1e-7 for now!)
    disp(['mean2(dIdz) = ' num2str(mean2(dIdz))]);
    warning('Conservation of Energy may not be satisfied!');
end
